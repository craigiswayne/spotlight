...
<head>
    ...
    <title>{{ config('app.name', 'Spotlight') }} Admin {{ WEBSITE_VERSION }}</title>

    <link href="/admin.build.css?{{ BUILD_VERSION }}" rel='stylesheet'>
    <script src="/shell.build.js?{{ BUILD_VERSION }}" defer></script>
    <script src="/admin.build.js?{{ BUILD_VERSION }}" defer></script>
...
<body>
    ...
    <div id="app" class="wrapper">
        ...
        <div class="sidebar" data-background-color="black">
            ...
            <div class="logo text-center mb-4">
                <a href="/admin/" class="simple-text logo-mini">
                    <img width="28" src="{{ asset('/assets/img/gg-symbol.png') }}" alt="image">
                </a>
                <a href="/admin/" class="simple-text logo-normal" style="text-align: initial;">                    
                    <img width="60" src="{{ asset('/assets/img/gg-title.png') }}" alt="image">
                </a>
            ...
            <div class="sidebar-wrapper">
                <ul class="nav">
                    ...
                    @if (Secure::hasAdminAccess('Profiles|View'))
                    ...
                    <li class="nav-item text-center {{Request::is('admin/profile/add') || Request::is('admin/profile/edit*') || Request::is('admin/profile/clone*')  ? 'active' : 'd-none'}}">
                        <a class="nav-link" href="/admin/profile">
                    ...
                    <li class="nav-item {{Request::is('admin/pages') ? 'active' : ''}}">
                        ...
                        @if ($hasAccessToAnyNavigationItem)
                        ...
                        <div id="resources" class="{{ $hasAccessToAnyNavigationItem ? 'collapse'  : ''}}
                                                   {{ ' ' }}
                                                   {{ !Request::is('admin/pages') && Request::is('admin/showreel*','admin/third-party-providers*', 'admin/games*', 'admin/studios*', 'admin/products*', 'admin/play-it-forward*', 'admin/markets*')  ? 'show' : ''}}" >
                            <ul class="nav">

                                @if (Secure::hasAdminAccess('Studios|View'))
                                <li class="nav-item {{Request::is('admin/studios*') ? 'active' : ''}}">
                                ...
                                @if (Secure::hasAdminAccess('Games|View'))
                                ...
                                @if (Secure::hasAdminAccess('Markets|View'))
                                ...
                                @if (Secure::hasAdminAccess('Third Party Providers|View'))
                                <li class="nav-item {{Request::is('admin/third-party-providers') ? 'active' : ''}}">
                                ...
                                @if (Secure::hasAdminAccess('Showreel|View'))
                                <li class="nav-item {{Request::is('admin/showreel') ? 'active' : ''}}">
                                ...
                                @if (Secure::hasAdminAccess('Products|View'))
                                ...
                                @if (Secure::hasAdminAccess('Play It Forward|View'))
                                <li class="nav-item {{Request::is('admin/play-it-forward') ? 'active' : ''}}">
                    ...
                    <div id="security" class="collapse {{ Request::is('admin/users*') || Request::is('admin/roles*')  ? 'show' : ''}}" >
                        <ul class="nav">
                            @if (Secure::hasAdminAccess('Users|View'))
                            <li class="nav-item {{Request::is('admin/users*') ? 'active' : ''}}">
                            ...
                            @endif
                            @if (Secure::hasAdminAccess('Roles|View'))
        ...
        @endif
        <div class="main-panel {{ Auth::check() ? '' : 'w-100'}}">
