<template>
  <div class="vue-form-wizard" :class="[stepSize, {vertical: isVertical}]" @keyup.right="focusNextTab"
      ...
      <loading :active.sync="busy" :is-full-page="false"></loading>
    ...
    <div class="wizard-navigation">
      <div :class="'wizard-progress-with-' + shape" v-if="!isVertical">
  ...
  export default {
    ...
    methods: {
      ...
      beforeTabChange (index, callback) {
        ...
        if (oldTab && oldTab.beforeChangeAsync !== undefined) {                   
          oldTab.beforeChangeAsync(callback);          
        } else if (oldTab && oldTab.beforeChange !== undefined) {
